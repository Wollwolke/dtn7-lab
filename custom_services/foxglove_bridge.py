...
class FoxgloveBridgeService(CoreService):
    """
    ...
    name: str = "FoxgloveBridge"
    group: str = "ROS2"
    executables: Tuple[str, ...] = ()
    dependencies: Tuple[str, ...] = ()
    dirs: Tuple[str, ...] = ()
    configs: Tuple[str, ...] = ("startFoxglove.sh", "stopFoxglove.sh")
    startup: Tuple[str, ...] = ("bash startFoxglove.sh",)
    validate: Tuple[str, ...] = ()
    validation_mode: ServiceMode = ServiceMode.NON_BLOCKING
    validation_timer: int = 5
    validation_period: float = 0.5
    shutdown: Tuple[str, ...] = ("bash stopFoxglove.sh", )
    ...
    def generate_config(cls, node: CoreNode, filename: str) -> str:
        ...
        """
        cfg = "#!/bin/bash\n# auto-generated by FoxgloveBridgeService (foxglove_bridge.py)\n"
...
ros2 launch foxglove_bridge foxglove_bridge_launch.xml &"""
            ...
            cfg += """
pgrep -f 'foxglove_bridge/foxglove_bridge' | xargs kill -2"""
        return cfg
