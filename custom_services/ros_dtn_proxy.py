...
class DtnProxyService(CoreService):
    """
    ...
    dirs: Tuple[str, ...] = ()
    configs: Tuple[str, ...] = ("startDtnProxy.sh", "stopDtnProxy.sh")
    startup: Tuple[str, ...] = ("bash startDtnProxy.sh",)
    validate: Tuple[str, ...] = ()
    validation_mode: ServiceMode = ServiceMode.NON_BLOCKING
    validation_timer: int = 5
    validation_period: float = 0.5
    shutdown: Tuple[str, ...] = ("bash stopDtnProxy.sh", )
    ...
    def generate_config(cls, node: CoreNode, filename: str) -> str:
        ...
        """
        cfg = "#!/bin/bash\n# auto-generated by DtnProxyService (ros_dtn_proxy.py)\n"
