...
class RosbagPlayerService(CoreService):
    """
    ...
    name: str = "RosbagPlayer"
    group: str = "ROS2"
    executables: Tuple[str, ...] = ()
    dependencies: Tuple[str, ...] = ()
    dirs: Tuple[str, ...] = ()
    configs: Tuple[str, ...] = ("playRosbag.sh", "killRosbag.sh")
    startup: Tuple[str, ...] = ("bash playRosbag.sh",)
    validate: Tuple[str, ...] = ()
    validation_mode: ServiceMode = ServiceMode.NON_BLOCKING
    validation_timer: int = 5
    validation_period: float = 0.5
    shutdown: Tuple[str, ...] = ("bash killRosbag.sh", )
    ...
    def generate_config(cls, node: CoreNode, filename: str) -> str:
        ...
        """
        cfg = "#!/bin/bash\n# auto-generated by RosbagPlayService (rosbag.py)\n"
        if filename == cls.configs[0]:
            cfg += """
source /opt/ros/humble/install/setup.bash
ros2 bag play --disable-keyboard-controls -l /shared/bags/5m_robot_tf &"""
        elif filename == cls.configs[1]:
            cfg += """
pgrep -f 'ros2 bag play' | xargs kill"""
        return cfg
